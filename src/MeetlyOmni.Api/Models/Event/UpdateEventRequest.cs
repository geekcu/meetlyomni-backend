...
{
    /// <summary>
    /// Gets or sets event title. Optional, 1-255 characters.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets event language preference. Optional, max 10 characters.
    /// </summary>
    [StringLength(10, ErrorMessage = "Language code cannot exceed 10 characters.")]
    public string? Language { get; set; }

    /// <summary>
    /// Gets or sets event status. Optional.
    /// </summary>
    public EventStatus? Status { get; set; }

    /// <summary>
    /// Gets or sets event start time. Optional.
    /// </summary>
    public DateTimeOffset? StartTime { get; set; }

    /// <summary>
    /// Gets or sets event end time. Optional.
    /// </summary>
